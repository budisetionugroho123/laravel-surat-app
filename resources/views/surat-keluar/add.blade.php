    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5">
                <form action="{{route('store.outmail.list')}}" method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal_keluar" class="form-control form-control-sm" id="tanggal_keluar" value="{{old('tanggal_keluar')}}" placeholder="masukkan tanggal keluar">
