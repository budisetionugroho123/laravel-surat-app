                        ...
                        @foreach ($letters as $letter)    
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('detail.outmail.list', $letter->id)}}" class="bi bi-eye bg-warning rounded text-white p-1 "></a>
                                    <a href="{{route('delete.outmail.list', $letter->id)}}" data-confirm-delete="true" class="bi bi-trash bg-danger rounded text-white p-1"></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
