        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    ...
                    <a href="{{ route('dashboard') }}" style="font-weight: 900; font-size: 18px">
                        Monitoring File Arsip <br> Cisadane Perdana
                    </a>
                </div>
                ...
                <nav class="flex items-center justify-between px-4 py-2">
                    <div class="flex items-center space-x-8">
                        <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'text-blue-500 font-bold py-2' : 'text-gray-500 py-2' }}">
                            Halaman Utama
                        </a>
                        <a href="{{ route('incoming.mail.list') }}" class="{{ request()->routeIs('incoming.mail.list') ? 'text-blue-500 font-bold py-2' : 'text-gray-500 py-2' }}">
                            Dokumen Masuk
                        </a>
                        <a href="{{ route('incoming.outmail.list') }}" class="{{ request()->routeIs('incoming.outmail.list') ? 'text-blue-500 font-bold py-2' : 'text-gray-500 py-2' }}">
                            Dokumen Keluar
                        </a>
                    </div>
                </nav>
