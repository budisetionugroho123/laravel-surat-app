    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5">
                <form action="{{route('edit.mail.list')}}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal_masuk" class="form-control form-control-sm" id="tanggal_masuk" value="{{old('tanggal_masuk', $letter->tanggal_masuk)}}" placeholder="masukkan tanggal keluar">
                            @error('tanggal_masuk')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
